...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Banner Management
    Route::post('/products/{product}/banner', [ProductManageController::class, 'uploadBanner'])->name('products.banner.upload');
    ...
    Route::post('/messages/{id}/reply', [\App\Http\Controllers\Admin\ContactMessageController::class, 'reply'])->name('messages.reply');
