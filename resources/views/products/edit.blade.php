        ...
        <div class="col-lg-8">
            <div class="card shadow-lg border-0">
                <div class="card-body p-5">
                    <h2 class="text-center mb-5 fw-bold text-warning">
                        Edit Product
                    </h2>
                    ...
                    <form action="{{ route('products.update', $product) }}" method="POST" enctype="multipart/form-data">
                        ...
                        @if($product->image)
                            <div class="text-center mb-5">
                                ...
                                <img src="{{ asset('storage/' . $product->image) }}" 
                                     class="current-img img-fluid" alt="Current Image">
                            </div>
                        @endif
                        ...
                        <div class="mb-4">
                            ...
                            <div class="upload-box" onclick="document.getElementById('image').click()">
                                ...
                                <img id="preview" src="" class="preview img-fluid mb-3" style="display: none;" alt="New Preview">
