                    ...
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="upload-box" onclick="document.getElementById('image').click()">
                                <!-- Preview Image -->
                                <img id="preview" src="" class="preview img-fluid mb-3" style="display: none;" alt="Preview">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <input type="number" name="price" class="form-control form-control-lg rounded-pill" 
                                       placeholder="Price in ₹" value="{{ old('price') }}" required>
                            ...
                            <div class="col-12">
                                <textarea name="description" class="form-control rounded-3" rows="4" 
                                          placeholder="Write product description (optional)">{{ old('description') }}</textarea>
                            </div>
                            ...
                            <div class="col-12 text-center mt-4">
                                ...
                                <a href="{{ route('products.index') }}" class="btn btn-secondary btn-lg px-5 py-3 rounded-pill ms-3">
                                    Cancel
                                </a>
                            </div>
                        </div>
